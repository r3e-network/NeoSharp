#r "../src/NeoSharp/bin/Debug/net9.0/NeoSharp.dll"
#r "../tests/NeoSharp.Tests/bin/Debug/net9.0/NeoSharp.Tests.dll"
...
Console.WriteLine($"Address: {TestConstants.DefaultAccountAddress}");
